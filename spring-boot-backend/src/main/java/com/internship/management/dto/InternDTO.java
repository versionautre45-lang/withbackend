...
public class InternDTO {
    ...
    public static InternDTO fromEntity(Intern intern) {
        return InternDTO.builder()
                ...
                .firstName(intern.getUser().getFirstName())
                .lastName(intern.getUser().getLastName())
                ...
                .encadreurName(intern.getEncadreur() != null ?
                    intern.getEncadreur().getUser().getFirstName() + " " +
                    intern.getEncadreur().getUser().getLastName() : null)
